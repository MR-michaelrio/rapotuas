						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$agamap = $row['agamap'];
											$desagamap = $row['desagamap'];
											$agamak = $row['agamak'];
											$desagamak = $row['desagamak'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $agamap; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desagamap; ?></td>
										<td style="padding-left: 10px;"><?php echo $agamak; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desagamak; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
