					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Bindo Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Bindo Keterampilan</td>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$bindop = $row['bindop'];
											$desbindop = $row['desbindop'];
											$bindok = $row['bindok'];
											$desbindok = $row['desbindok'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $bindop; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desbindop; ?></td>
										<td style="padding-left: 10px;"><?php echo $bindok; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desbindok; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
