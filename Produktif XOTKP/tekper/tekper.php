					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Teknologi Perkantoran Pengetahuan</td>
										<td align=center>Teknologi Perkantoran Keterampilan</td>
									</tr>
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											$id = (int) $row['id'];
											$nama = $row['nama'];
											$tekperkantoranp = $row['tekperkantoranp'];
											$tekperkantorank = $row['tekperkantorank'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $tekperkantoranp; ?></td>
										<td style="padding-left: 10px;"><?php echo $tekperkantorank; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
