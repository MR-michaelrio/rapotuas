					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Korespondensi Pengetahuan</td>
										<td align=center>Korespondensi Keterampilan</td>
									</tr>
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											$id = (int) $row['id'];
											$nama = $row['nama'];
											$korespondensip = $row['korespondensip'];
											$korespondensik = $row['korespondensik'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $korespondensip; ?></td>
										<td style="padding-left: 10px;"><?php echo $korespondensik; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
