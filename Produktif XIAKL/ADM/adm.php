					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Administrasi Pajak Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Administrasi Pajak Keterampilan</td>
								   ...
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $admp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desadmp; ?></td>
										<td style="padding-left: 10px;"><?php echo $admk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desadmk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
