...
<td>Nama</td>
<td>NIS</td>
<td align=center>Akuang Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Akuang Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="akuangp[]" class="txtField" value="<?php echo $row['akuangp']; ?>"></td>
<td><input type="text" name="desakuangp[]" class="txtField" value="<?php echo $row['desakuangp']; ?>"></td>
<td><input type="text" name="akuangk[]" class="txtField" value="<?php echo $row['akuangk']; ?>"></td>
<td><input type="text" name="desakuangk[]" class="txtField" value="<?php echo $row['desakuangk']; ?>"></td>
