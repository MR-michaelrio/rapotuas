					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Akutansi Keuangan Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Akutansi Keuangan Keterampilan</td>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$akuangp = $row['akuangp'];
											$desakuangp = $row['desakuangp'];
											$akuangk = $row['akuangk'];
											$desakuangk = $row['desakuangk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $akuangp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desakuangp; ?></td>
										<td style="padding-left: 10px;"><?php echo $akuangk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desakuangk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
