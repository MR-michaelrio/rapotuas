...
<td>Nama</td>
<td>NIS</td>
<td align=center>Akpem Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Akpem Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="akpemp[]" class="txtField" value="<?php echo $row['akpemp']; ?>"></td>
<td><input type="text" name="desakpemp[]" class="txtField" value="<?php echo $row['desakpemp']; ?>"></td>
<td><input type="text" name="akpemk[]" class="txtField" value="<?php echo $row['akpemk']; ?>"></td>
<td><input type="text" name="desakpemk[]" class="txtField" value="<?php echo $row['desakpemk']; ?>"></td>
