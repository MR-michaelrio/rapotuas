					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Praktikum Akutansi Lembaga/Instansi Pemerintah Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Praktikum Akutansi Lembaga/Instansi Pemerintah Keterampilan</td>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$akpemp = $row['akpemp'];
											$desakpemp = $row['desakpemp'];
											$akpemk = $row['akpemk'];
											$desakpemk = $row['desakpemk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $akpemp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desakpemp; ?></td>
										<td style="padding-left: 10px;"><?php echo $akpemk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desakpemk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
