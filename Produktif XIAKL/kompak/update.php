...
<td>Nama</td>
<td>NIS</td>
<td align=center>Kompak Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Kompak Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="kompakp[]" class="txtField" value="<?php echo $row['kompakp']; ?>"></td>
<td><input type="text" name="deskompakp[]" class="txtField" value="<?php echo $row['deskompakp']; ?>"></td>
<td><input type="text" name="kompakk[]" class="txtField" value="<?php echo $row['kompakk']; ?>"></td>
<td><input type="text" name="deskompakk[]" class="txtField" value="<?php echo $row['deskompakk']; ?>"></td>
