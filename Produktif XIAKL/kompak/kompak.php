					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Komputer Akutansi Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Komputer Akutansi Keterampilan</td>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$kompakp = $row['kompakp'];
											$deskompakp = $row['deskompakp'];
											$kompakk = $row['kompakk'];
											$deskompakk = $row['deskompakk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $kompakp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $deskompakp; ?></td>
										<td style="padding-left: 10px;"><?php echo $kompakk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $deskompakk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
