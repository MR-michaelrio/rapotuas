...
<td>Nama</td>
<td>NIS</td>
<td align=center>Jasdag Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Jasdag Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="jasdagp[]" class="txtField" value="<?php echo $row['jasdagp']; ?>"></td>
<td><input type="text" name="desjasdagp[]" class="txtField" value="<?php echo $row['desjasdagp']; ?>"></td>
<td><input type="text" name="jasdagk[]" class="txtField" value="<?php echo $row['jasdagk']; ?>"></td>
<td><input type="text" name="desjasdagk[]" class="txtField" value="<?php echo $row['desjasdagk']; ?>"></td>
