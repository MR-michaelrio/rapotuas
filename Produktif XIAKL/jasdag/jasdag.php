					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Praktikum Akutansi Perusahaan Jasa, Dagang dan Manufaktur Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Praktikum Akutansi Perusahaan Jasa, Dagang dan Manufaktur Keterampilan</td>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$jasdagp = $row['jasdagp'];
											$desjasdagp = $row['desjasdagp'];
											$jasdagk = $row['jasdagk'];
											$desjasdagk = $row['desjasdagk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $jasdagp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desjasdagp; ?></td>
										<td style="padding-left: 10px;"><?php echo $jasdagk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desjasdagk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
