...
<td>Nama</td>
<td>NIS</td>
<td align=center>Humas dan Keprotokolan Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Humas dan Keprotokolan Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="humasp[]" class="txtField" value="<?php echo $row['humasp']; ?>"></td>
<td><input type="text" name="deshumasp[]" class="txtField" value="<?php echo $row['deshumasp']; ?>"></td>
<td><input type="text" name="humask[]" class="txtField" value="<?php echo $row['humask']; ?>"></td>
<td><input type="text" name="deshumask[]" class="txtField" value="<?php echo $row['deshumask']; ?>"></td>
