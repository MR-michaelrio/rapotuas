...
<td>Nama</td>
<td>NIS</td>
<td align=center>Keuangan Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Keuangan Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="keuanganp[]" class="txtField" value="<?php echo $row['keuanganp']; ?>"></td>
<td><input type="text" name="deskeuanganp[]" class="txtField" value="<?php echo $row['deskeuanganp']; ?>"></td>
<td><input type="text" name="keuangank[]" class="txtField" value="<?php echo $row['keuangank']; ?>"></td>
<td><input type="text" name="deskeuangank[]" class="txtField" value="<?php echo $row['deskeuangank']; ?>"></td>
