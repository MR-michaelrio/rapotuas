...
<td>Nama</td>
<td>NIS</td>
<td align=center>Kepegawaian Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Kepegawaian Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="kepegawaianp[]" class="txtField" value="<?php echo $row['kepegawaianp']; ?>"></td>
<td><input type="text" name="deskepegawaianp[]" class="txtField" value="<?php echo $row['deskepegawaianp']; ?>"></td>
<td><input type="text" name="kepegawaiank[]" class="txtField" value="<?php echo $row['kepegawaiank']; ?>"></td>
<td><input type="text" name="deskepegawaiank[]" class="txtField" value="<?php echo $row['deskepegawaiank']; ?>"></td>
