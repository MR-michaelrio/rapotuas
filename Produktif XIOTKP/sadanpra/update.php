...
<td>Nama</td>
<td>NIS</td>
<td align=center>Sarana dan Prasarana Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Sarana dan Prasarana Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="sadanprap[]" class="txtField" value="<?php echo $row['sadanprap']; ?>"></td>
<td><input type="text" name="dessadanprap[]" class="txtField" value="<?php echo $row['dessadanprap']; ?>"></td>
<td><input type="text" name="sadanprak[]" class="txtField" value="<?php echo $row['sadanprak']; ?>"></td>
<td><input type="text" name="dessadanprak[]" class="txtField" value="<?php echo $row['dessadanprak']; ?>"></td>
