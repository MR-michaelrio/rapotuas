					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Penjas Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Penjas Keterampilan</td>
								   ...
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $orp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desorp; ?></td>
										<td style="padding-left: 10px;"><?php echo $ork; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desork; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
