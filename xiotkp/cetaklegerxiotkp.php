...
<body>
	...
	header("Content-Disposition: attachment; filename=ledgerxiotkp.xls");
	?>
 
 <?php
require_once "../koneksi.php";
$result = mysqli_query($conn, "SELECT * FROM xiotkp");
?>
...
<!-- kepegawaian -->
<td><?php echo $row ["kepegawaianp"]?></td>
<td><?php echo $deskepegawaianpp; echo $row ["deskepegawaianp"]?></td>
<td><?php echo $row ["kepegawaiank"]?></td>
<td><?php echo $deskepegawaiankk; echo $row ["deskepegawaiank"]?></td>

<!-- keuangan -->
<td><?php echo $row ["keuanganp"]?></td>
<td><?php echo $deskeuanganpp; echo $row ["deskeuanganp"]?></td>
<td><?php echo $row ["keuangank"]?></td>
<td><?php echo $deskeuangankk; echo $row ["deskeuangank"]?></td>

<!-- sadanpra -->
<td><?php echo $row ["sadanprap"]?></td>
<td><?php echo $dessadanprapp; echo $row ["dessadanprap"]?></td>
<td><?php echo $row ["sadanprak"]?></td>
<td><?php echo $dessadanprakk; echo $row ["dessadanprak"]?></td>

<!-- humas -->
<td><?php echo $row ["humasp"]?></td>
<td><?php echo $deshumaspp; echo $row ["deshumasp"]?></td>
<td><?php echo $row ["humask"]?></td>
<td><?php echo $deshumaskk; echo $row ["deshumask"]?></td>
