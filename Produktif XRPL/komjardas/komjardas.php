					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Komputer dan Jaringan Dasar Pengetahuan</td>
										<td align=center>Komputer dan Jaringan Dasar Keterampilan</td>
									</tr>
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											$id = (int) $row['id'];
											$nama = $row['nama'];
											$komjardasp = $row['komjardasp'];
											$komjardask = $row['komjardask'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $komjardasp; ?></td>
										<td style="padding-left: 10px;"><?php echo $komjardask; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
