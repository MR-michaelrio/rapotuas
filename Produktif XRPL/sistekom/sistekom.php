					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Sistem Komputer Pengetahuan</td>
										<td align=center>Sistem Komputer Keterampilan</td>
									</tr>
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											$id = (int) $row['id'];
											$nama = $row['nama'];
											$sistekomp = $row['sistekomp'];
											$sistekomk = $row['sistekomk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $sistekomp; ?></td>
										<td style="padding-left: 10px;"><?php echo $sistekomk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
