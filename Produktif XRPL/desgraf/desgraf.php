					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Dasar Desain Grafis Pengetahuan</td>
										<td align=center>Dasar Desain Grafis Keterampilan</td>
									</tr>
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											$id = (int) $row['id'];
											$nama = $row['nama'];
											$desgrafp = $row['desgrafp'];
											$desgrafk = $row['desgrafk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $desgrafp; ?></td>
										<td style="padding-left: 10px;"><?php echo $desgrafk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
