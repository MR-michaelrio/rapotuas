						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$bingp = $row['bingp'];
											$desbingp = $row['desbingp'];
											$bingk = $row['bingk'];
											$desbingk = $row['desbingk'];
									?>
									...
									<tr>
										   ...
										   <td style="padding-left: 10px;"><?php echo $bingp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desbingp; ?></td>
										<td style="padding-left: 10px;"><?php echo $bingk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desbingk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
