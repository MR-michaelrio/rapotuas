...
<td><input type="text" name="kwup[]" class="txtField" value="<?php echo $row['kwup']; ?>"></td>
<td><input type="text" name="deskwup[]" class="txtField" value="<?php echo $row['deskwup']; ?>"></td>
<td><input type="text" name="kwuk[]" class="txtField" value="<?php echo $row['kwuk']; ?>"></td>
<td><input type="text" name="deskwuk[]" class="txtField" value="<?php echo $row['deskwuk']; ?>"></td>
