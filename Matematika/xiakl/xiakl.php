						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $mtkp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desmtkp; ?></td>
										<td style="padding-left: 10px;"><?php echo $mtkk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desmtkk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
