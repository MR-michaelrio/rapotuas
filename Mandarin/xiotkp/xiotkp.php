						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$mandap = $row['mandap'];
											$desmandap = $row['desmandap'];
											$mandak = $row['mandak'];
											$desmandak = $row['desmandak'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $mandap; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desmandap; ?></td>
										<td style="padding-left: 10px;"><?php echo $mandak; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desmandak; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
