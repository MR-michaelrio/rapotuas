					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Permodelan Perangkat Lunak Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Permodelan Perangkat Lunak Keterampilan</td>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$permodp = $row['permodp'];
											$despermodp = $row['despermodp'];
											$permodk = $row['permodk'];
											$despermodk = $row['despermodk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $permodp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $despermodp; ?></td>
										<td style="padding-left: 10px;"><?php echo $permodk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $despermodk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
