...
<td>Nama</td>
<td>NIS</td>
<td align=center>Permod Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Permod Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="permodp[]" class="txtField" value="<?php echo $row['permodp']; ?>"></td>
<td><input type="text" name="despermodp[]" class="txtField" value="<?php echo $row['despermodp']; ?>"></td>
<td><input type="text" name="permodk[]" class="txtField" value="<?php echo $row['permodk']; ?>"></td>
<td><input type="text" name="despermodk[]" class="txtField" value="<?php echo $row['despermodk']; ?>"></td>
