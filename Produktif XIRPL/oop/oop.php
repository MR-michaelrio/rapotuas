					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Perograman Berorientasi Objek Pengetahuan</td>
										<td align=center>Deskripsi Pengetahuan</td>
										<td align=center>Perograman Berorientasi Objek Keterampilan</td>
								   ...
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $oopp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desoopp; ?></td>
										<td style="padding-left: 10px;"><?php echo $oopk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desoopk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
