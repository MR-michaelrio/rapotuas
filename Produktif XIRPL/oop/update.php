...
<td>Nama</td>
<td>NIS</td>
<td align=center>OOP Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>OOP Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="oopp[]" class="txtField" value="<?php echo $row['oopp']; ?>"></td>
<td><input type="text" name="desoopp[]" class="txtField" value="<?php echo $row['desoopp']; ?>"></td>
<td><input type="text" name="oopk[]" class="txtField" value="<?php echo $row['oopk']; ?>"></td>
<td><input type="text" name="desoopk[]" class="txtField" value="<?php echo $row['desoopk']; ?>"></td>
