						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											...
											$nama = $row['nama'];
											$basisp = $row['basisp'];
											$desbasisp = $row['desbasisp'];
											$basisk = $row['basisk'];
											$desbasisk = $row['desbasisk'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $basisp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desbasisp; ?></td>
										<td style="padding-left: 10px;"><?php echo $basisk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $desbasisk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
