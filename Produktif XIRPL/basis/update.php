...
<td>Nama</td>
<td>NIS</td>
<td align=center>Basis data Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Basis data Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="basisp[]" class="txtField" value="<?php echo $row['basisp']; ?>"></td>
<td><input type="text" name="desbasisp[]" class="txtField" value="<?php echo $row['desbasisp']; ?>"></td>
<td><input type="text" name="basisk[]" class="txtField" value="<?php echo $row['basisk']; ?>"></td>
<td><input type="text" name="desbasisk[]" class="txtField" value="<?php echo $row['desbasisk']; ?>"></td>
