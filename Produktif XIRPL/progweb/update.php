...
<td>Nama</td>
<td>NIS</td>
<td align=center>Progweb Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Progweb Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="progwebp[]" class="txtField" value="<?php echo $row['progwebp']; ?>"></td>
<td><input type="text" name="desprogwebp[]" class="txtField" value="<?php echo $row['desprogwebp']; ?>"></td>
<td><input type="text" name="progwebk[]" class="txtField" value="<?php echo $row['progwebk']; ?>"></td>
<td><input type="text" name="desprogwebk[]" class="txtField" value="<?php echo $row['desprogwebk']; ?>"></td>
