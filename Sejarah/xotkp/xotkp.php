						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $sjrp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $dessjrp; ?></td>
										<td style="padding-left: 10px;"><?php echo $sjrk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $dessjrk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
