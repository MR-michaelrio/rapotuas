					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Akuntansi Dasar Pengetahuan</td>
										<td align=center>Akuntansi Dasar Keterampilan</td>
									</tr>
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $akunp; ?></td>
										<td style="padding-left: 10px;"><?php echo $akunk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
