					...
					<div class="panel panel-headline">
						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
									...
									<tr>
										...
										<td align=center>Perbankan Dasar Pengetahuan</td>
										<td align=center>Perbankan Dasar Keterampilan</td>
									</tr>
								   <?php
										...
										while ($row = mysqli_fetch_assoc($query)) {
											$id = (int) $row['id'];
											$nama = $row['nama'];
											$perbankanp = $row['perbankanp'];
											$perbankank = $row['perbankank'];
									?>
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $perbankanp; ?></td>
										<td style="padding-left: 10px;"><?php echo $perbankank; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
