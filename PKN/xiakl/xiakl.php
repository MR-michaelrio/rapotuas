						...
						<a href=nilai/update.php class="btn btn-success" style=margin-bottom:5px;>Import Nilai</a>
								   ...
								   <?php
									...
									<tr>
										...
										<td style="padding-left: 10px;"><?php echo $pknp; ?></td>
   										<td style="padding-left: 10px;"><?php echo $despknp; ?></td>
										<td style="padding-left: 10px;"><?php echo $pknk; ?></td>
   										<td style="padding-left: 10px;"><?php echo $despknk; ?></td>
  									</tr>
										<?php } ?>
									</table>
									<center>
